...
data Game = Game
    ...
    , gStake          :: !Integer
    , gPlayDeadline   :: !POSIXTime  -- by what time second player need to play
    , gRevealDeadline :: !POSIXTime  -- by when first player should reveal
    , gToken          :: !AssetClass -- arbitrary NFT to identify right instance of utxo
